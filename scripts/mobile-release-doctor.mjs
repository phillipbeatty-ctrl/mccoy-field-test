...
check('sale photo staging bundled',Boolean(mobileIndex?.includes('app-sale-photo-staging.js?v=2026090201')),'repaired photo staging is missing from the native bundle');
