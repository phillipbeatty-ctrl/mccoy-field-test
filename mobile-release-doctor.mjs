...
check('sale lifecycle bundled',Boolean(mobileIndex?.includes('app-sale-lifecycle.js?v=2026090201')),'repaired sale lifecycle is missing from the native bundle');
check('sale photo staging bundled',Boolean(mobileIndex?.includes('app-sale-photo-staging.js?v=2026091403')),'repaired photo staging is missing from the native bundle');
