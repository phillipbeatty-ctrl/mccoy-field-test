...
const pageLayoutSource=readFileSync(new URL('./app-page-layout.js',import.meta.url),'utf8')
...
test('client and cache contracts ship the fixed runtime to web, PWA, iOS, and Android bundles',()=>{
  ...
  assert.match(indexSource,/app-sales-products\.js\?v=2026090201/)
  assert.match(indexSource,/app-customer-list-credit-ranking-refresh\.js\?v=2026090201/)
  assert.match(indexSource,/app-page-layout\.js\?v=2026090201/)
  assert.match(pageLayoutSource,/app-sale-lifecycle\.js\?v=2026090201/)
  assert.match(pageLayoutSource,/app-sale-photo-staging\.js\?v=2026090201/)
  assert.match(workerSource,/field-coach-app-shell-v7-20260902-sale-completion-runtime/)
