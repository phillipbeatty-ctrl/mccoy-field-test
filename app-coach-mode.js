  ...
  async function loadVisibilityPanel(){
    ...
    try{
      ...
      root.innerHTML=`
        ...
        <div class="metrics-row"><div><strong>Managers can view assigned reps</strong><div class="metrics-muted">Only reps actually assigned to that manager are accessible.</div></div><input id="globalManagerMetrics" type="checkbox" ${g.global_manager_metrics_enabled?'checked':''}></div>
