...
test('cache versions force the cleaned Sales Hub assets to replace the redundant UI',()=>{
  ...
  for(const asset of ['app-part1.js','app-field-addresses.js','app-distance-to-lead.js','app-provider-sale-router.js'])assert.match(html,new RegExp(`${asset.replaceAll('.','\\.')}\\?v=${asset==='app-provider-sale-router.js'?'2026091301':asset==='app-distance-to-lead.js'?'2026091106':'2026091103'}`));
