...
(function(){
  ...
  function bindIncompleteBankActions(row,index){
    const approve=document.getElementById('saleIncompleteApprove'+index),review=document.getElementById('saleIncompleteReview'+index);
    approve.onclick=async()=>{
      ...
      }catch(error){setNotice(error?.message||'Unable to approve incomplete McCoy evidence.');approve.disabled=false;approve.textContent='APPROVE & ASSIGN';}
    };
