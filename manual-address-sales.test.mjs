...
test('web cache loads the pause before all legacy automatic selectors',()=>{
  ...
  assert.match(worker,/field-coach-app-shell-v28-20260913-photo-recovery/);
  for(const name of ['app-field-features.js','app-typed-lead-address.js','app-provider-sale-router.js','app-field-lead-editor.js'])assert.ok(worker.includes(name+'?v='+(name==='app-provider-sale-router.js'?'2026091301':name==='app-field-features.js'?'2026091103':name==='app-field-lead-editor.js'?'2026091108':'2026091108')));
