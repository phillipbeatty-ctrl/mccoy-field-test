...
(function(){
  ...
  function ensureDashboardRankings(){
    ...
    if(rankingIntro)rankingIntro.textContent='Every active rep, Manager, and Trainer, ranked by provider-verified sales. Later cancellations affect accounting only and do not remove ranking credit.';
