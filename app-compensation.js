...
(function(){
  ...
  if(field){
    const pay=document.createElement('div');pay.className='pay-progress-card';pay.id='payProgressCard';pay.innerHTML='<strong>Weekly Pay Progress</strong><div id="payProgressMain" class="pay-progress-main">Loading…</div><div id="payProgressSub" class="pay-progress-sub"></div>';field.parentNode?.insertBefore(pay,field);
    const leaders=document.createElement('div');leaders.className='leaders-card';leaders.innerHTML='<strong>🏆 Company Leaders</strong><div class="leaders-grid"><div class="leader-tile"><span>Today</span><strong id="leadToday">—</strong><small id="leadTodayCount"></small></div><div class="leader-tile"><span>This Week</span><strong id="leadWeek">—</strong><small id="leadWeekCount"></small></div><div class="leader-tile"><span>This Month</span><strong id="leadMonth">—</strong><small id="leadMonthCount"></small></div><div class="leader-tile"><span>This Year</span><strong id="leadYear">—</strong><small id="leadYearCount"></small></div><div class="leader-tile"><span>All Time</span><strong id="leadAll">—</strong><small id="leadAllCount"></small></div></div>';field.parentNode?.insertBefore(leaders,field);
  }
