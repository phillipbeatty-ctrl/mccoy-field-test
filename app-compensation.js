  ...
  async function loadControls(){
    ...
    try{
      ...
      root.innerHTML=`
        ...
        <div class="comp-section"><strong>Manager Override Authority</strong><div class="comp-muted">Admin can activate or deactivate override credit for each manager. The setting is keyed to the manager's login email and every change is audited.</div><div id="mgrRows"></div><div id="managerOverrideMessage" class="comp-muted" role="status" aria-live="polite"></div></div><div class="comp-section"><strong>Per Assigned Rep</strong><div class="comp-muted">Effective only if the master switch, manager switch, and rep switch are all on.</div><div id="repRows"></div></div>`;
