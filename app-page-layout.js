(()=>{
  ...
  function loadSaleLifecycle(){for(const src of ['app-sale-lifecycle.js?v=2026082801','app-sales-hub-layout.js?v=2026082801','app-sale-photo-staging.js?v=2026082801','app-sales-to-complete.js?v=2026082602','app-sale-order-photo-admin.js?v=2026082601']){if(document.querySelector(`script[src^="${src.split('?')[0]}"]`))continue;const script=document.createElement('script');script.src=src;script.defer=true;document.body.appendChild(script);}}
